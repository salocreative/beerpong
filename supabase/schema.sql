...
create type team_state as enum ('registered', 'queued', 'playing', 'withdrawn');
...
-- ---------------------------------------------------------------------------
-- end_event — freeze phase + pause timers at closed_at
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- reset_event — wipe teams/matches and return to registration
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Mid-tournament: fill waiting tables, late join, skip, withdraw
-- ---------------------------------------------------------------------------
...
grant execute on function start_tournament(uuid, uuid[]) to anon, authenticated;
grant execute on function complete_match(uuid, uuid) to anon, authenticated;
